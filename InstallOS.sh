...
function Start() {
  ...
  wget --no-check-certificate -qO /tmp/InstallNET.sh 'https://raw.githubusercontent.com/FreezingIris/InstallLinuxOS/main/InstallNET.sh' && chmod a+x /tmp/InstallNET.sh
